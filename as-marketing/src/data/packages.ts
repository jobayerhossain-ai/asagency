        ...
        subPackages: [
            {
                ...
                note: 'বিঃদ্রঃ আমরা ব্যাংকের কার্ড দিয়ে বুস্ট করে থাকি ।এছাড়াও আপনি আপনার ইচ্ছামত ডলার দিয়ে বুস্ট করতে পারবেন । সর্বনিম্ন ১০ ডলার থেকে শুরু । পার ডলার ১৪৫ টাকা মাত্র । টার্গেট অডিয়েন্স নির্ধারণ করে বুস্ট করতে পারবেন । এরিয়া ভিত্তিক বুস্ট করতে পারবেন । হটলাইনঃ ০১৭৪৭-৯৮০৬৬২ ।',
                options: [
                    { name: '১০ দিনের জন্য ১০ ডলার', price: '১৪৫০ টাকা' },
                    { name: '১৫ দিনের জন্য ১৫ ডলার', price: '২১৭৫ টাকা' },
                    { name: '২০ দিনের জন্য ২০ ডলার', price: '২৯০০ টাকা' },
                    { name: '২৫ দিনের জন্য ২৫ ডলার', price: '৩৬২৫ টাকা' },
                    { name: '৩০ দিনের জন্য ৩০ ডলার', price: '৪৩৫০ টাকা' },
                ]
            },
            {
                title: 'ফেসবুক ফলোয়ার প্যাকেজ',
                note: 'বিঃদ্রঃ আমরা ব্যাংকের কার্ড দিয়ে প্রমোট করে থাকি । প্রত্যেকটি লাইক ফলোয়ার পেইড এবং অর্গানিক ।আপনার পেজের লাইক ফলোয়ার এক্টিভ অ্যাকাউন্ট থেকে পড়বে । হটলাইনঃ ০১৭৪৭-৯৮০৬৬২ ।',
                options: [
    ...
    },
    {
        ...
        subPackages: [
            ...
            },
            {
                ...
                note: 'বিঃদ্রঃ আমরা ব্যাংকের কার্ড দিয়ে প্রমোট করে থাকি । প্রত্যেকটি ফলোয়ার পেইড এবং অর্গানিক ।আপনার ইনস্টাগ্রাম পেজের ফলোয়ার এক্টিভ অ্যাকাউন্ট থেকে পড়বে । হটলাইনঃ ০১৭৪৭-৯৮০৬৬২ ।',
                options: [
