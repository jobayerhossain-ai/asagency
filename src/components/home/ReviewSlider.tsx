                    ...
                    <div className="flex overflow-hidden">
                        ...
                        >
                            ...
                            {[...reviews, ...reviews].map((review, idx) => (
                                <div
                                    key={`${review.id}-${idx}`}
                                    className="relative flex-none w-[280px] md:w-[350px] aspect-video rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 bg-white border-2 border-blue-700/50 hover:border-blue-700"
                                >
                                    <Image
                                        src={review.src}
                                        alt={review.alt}
